                ...
                >
                    <Link href="/">
                        <a className="navbar-brand p-0 m-0 img-logo-title-menu-mobile closemenu">
                            ...
                            /> */}
                            <span>
                                <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/logo_1.png/`} alt="Logo" width={216} height={28}/>
                            </span>
                        </a>
                    </Link>
                </div>
                                            ...
                                            <ul className="show-site-sub-menu title-menu-mobile">
                                                <li className="title-menu-mobile arrow-back-to-menu-mobile">
                                                    ...
                                                    <span className="arrow-back-to-menu-mobile">
                                                        <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/left-arrow.png`} alt="left-arrow.png" width={34} height={34}/>
                                                    </span>
                                                </li>
                                                    ...
                                                    <a>
                                                        <a className="closemenu">
                                                            ...
                                                            <span className="icon-title-menu-mobile">
                                                                <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_Product-icon01.svg`} alt="menu-icon_Product-icon01.svg" width={50} height={50}/>
                                                            </span>
                                                            {t.header['Our Strength']}
                                                        </a>
                                                    </a>
                                            ...
                                            <ul className="title-sub-menu">
                                                <li className="sub-head-menu">
                                                    ...
                                                    <a className="closemenu">
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_Product-icon02.svg`} alt="menu-icon_Product-icon02.svg" width={50} height={50}/>
                                                        </span>
                                                        Smart SMS Console
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    <a className="closemenu">
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_Product-icon03.svg`} alt="menu-icon_Product-icon03.svg" width={50} height={50}/>
                                                        </span>
                                                        SMS Tracking
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_Product-icon04.svg`} alt="menu-icon_Product-icon04.svg" width={50} height={50}/>
                                                        </span>
                                                        Location Based SMS
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_Product-icon05.svg`} alt="menu-icon_Product-icon05.svg" width={50} height={50}/>
                                                        </span>
                                                        Global SMS
                                                    </a>
                                                    </Link>
                                            ...
                                            <ul className="title-sub-menu">
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_Product-icon06.svg`} alt="menu-icon_Product-icon06.svg" width={50} height={50}/>
                                                        </span>
                                                        SMS API
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_Product-icon07.svg`} alt="menu-icon_Product-icon07.svg" width={50} height={50}/>
                                                        </span>
                                                        OTP Service
                                                    </a>
                                                    </Link>
                                            ...
                                            <ul className="title-sub-menu">
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_resource-icon01.svg`} alt="menu-icon_resource-icon01.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header.Database}
                                                    </a>
                                                    </Link>
                                            ...
                                            <ul className="title-sub-menu">
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_resource-icon05.svg`} alt="menu-icon_resource-icon05.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header.Marketing}
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_resource-icon06.svg`} alt="menu-icon_resource-icon06.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header.Tech}
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_resource-icon07.svg`} alt="menu-icon_resource-icon07.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header['ThaiBulkSMS Features']}
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_resource-icon03.svg`} alt="menu-icon_resource-icon03.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header['Example Operations']}
                                                    </a>
                                                    </Link>
                                            ...
                                            <ul className="title-sub-menu">
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_resource-icon04.svg`} alt="menu-icon_resource-icon04.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header['Success Stories']}
                                                    </a>
                                                    </Link>
                                            ...
                                            <ul className="title-sub-menu">
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_support-icon01.svg`} alt="menu-icon_support-icon01.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header['Ordering Methods']}
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_support-icon02.svg`} alt="menu-icon_support-icon02.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header['Frequently Asked Questions']}
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_support-icon03.svg`} alt="menu-icon_support-icon03.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header['Contact us']}
                                                    </a>
                                                    </Link>
                                            ...
                                            <ul className="title-sub-menu">
                                                <li className="sub-head-menu">
                                                    ...
                                                    <a>
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/phone.png`} alt="phone.png" width={30} height={30}/>
                                                        </span>
                                                        02-798-6000
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    <a>
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/mail.png`} alt="mail.png" width={30} height={30}/>
                                                        </span>
                                                        contact@thaibulksms.com
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    <a>
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/fb.png`} alt="fb.png" width={30} height={30}/>
                                                        </span>
                                                        ThaiBulkSMS
                                                    </a>
                                                    </Link>
                                            ...
                                            <ul className="title-sub-menu">
                                                <li className="sub-head-menu">
                                                    ...
                                                    <a>
                                                        <div className="closemenu">
                                                            ...
                                                            /> */}
                                                            <span className="icon-title-menu-mobile">
                                                                <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_Dev-icon01.svg`} alt="menu-icon_Dev-icon01.svg" width={50} height={50}/>
                                                            </span>
                                                            {t.header['Download Guide']}
                                                        </div>
                                                    </a>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_Dev-icon02.svg`} alt="menu-icon_Dev-icon02.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header['Download Example SDK']}
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_Dev-icon03.svg`} alt="menu-icon_Dev-icon03.svg" width={50} height={50}/>
                                                        </span>
                                                        API References
                                                    </a>
                                                    </Link>
                                            ...
                                            <ul className="title-sub-menu">
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_about-icon01.svg`} alt="menu-icon_about-icon01.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header['Why use ThaiBulkSMS?']}
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_about-icon02.svg`} alt="menu-icon_about-icon02.svg" width={50} height={50}/>
                                                        </span>
                                                        {t.header['Contact us']}
                                                    </a>
                                                    </Link>
                                                ...
                                                <li className="sub-head-menu">
                                                    ...
                                                    >
                                                        ...
                                                        /> */}
                                                        <span className="icon-title-menu-mobile">
                                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/menu-icon_about-icon03.svg`} alt="menu-icon_about-icon03.svg" width={50} height={50}/>
                                                        </span>
                                                        Reseller Program
                                                    </a>
                                                    </Link>
