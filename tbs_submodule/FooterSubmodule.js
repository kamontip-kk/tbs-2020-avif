                        ...
                        <div className="footer_contact">
                            ...
                            <a>
                                ...
                                <span className="lazyload">
                                    <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/phone.png`} alt="Image" width={30} height={30}/>
                                </span>
                                02-798-6000
                            </a>
                            </Link>
                            ...
                            <a>
                                ...
                                /> */}
                                <span className="lazyload">
                                    <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/mail.png`} alt="Image" width={30} height={30}/>
                                </span>
                                {' '}
                                <span
                            ...
                            >
                                ...
                                /> */}
                                <span className="lazyload">
                                    <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/fb.png`} alt="Image" width={30} height={30}/>
                                </span>
                                Follow Us
                            </a>
                            </Link>
                            ...
                            <div className="row align-items-end">
                                <div className="col-xl-6 col-lg-5 col-md-5">
                                    <div className="footer_logo">
                                        ...
                                        /> */}
                                        <span className="lazyload">
                                            <Image src={`${process.env.NEXT_PUBLIC_BASE_ASSET}/img/logo_2.png`} alt="Image" width={253} height={34}/>
                                        </span>
                                    </div>
                                </div>
